...
class TrackersControllerTest < ActionController::TestCase
  ...
  test "should create tracker" do
    assert_difference('Tracker.count') do
      post :create, tracker: { active: @tracker.active, bus_id: @tracker.bus_id, track: @tracker.track, user_id: @tracker.user_id }
    end
  ...
  test "should update tracker" do
    put :update, id: @tracker, tracker: { active: @tracker.active, bus_id: @tracker.bus_id, track: @tracker.track, user_id: @tracker.user_id }
    assert_redirected_to tracker_path(assigns(:tracker))
  end
